...
private int numMissed;       // Number of questions missed 1
     /**
...
public FinalExam2(int questions, int missed) 
    { 
double numericScore;        // To hold a numeric score 23
...
If score is within 0.5 points of the next whole number, it rounds the score up. 
     */ 
private void adjustScore() 
       {
 double fraction;  // Get the fractional part of the score. 
  fraction = score - (int) score;       // If the fractional part is .5 or greater, 
